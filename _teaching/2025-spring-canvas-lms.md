...
permalink: /teaching/2025-canvas-lms
...
- Supported **125+ graduate students** across multiple courses
- Implemented modular course templates ensuring consistency across program offerings
- Created automated grading workflows reducing instructor workload

### Impact Metrics

| Metric | Improvement |
|--------|-------------|
| Course Satisfaction | **+30%** increase in scores |
| Instructor Setup Time | **-40%** reduction |
...
- **Standardized Rubrics**: Created consistent grading criteria across courses
